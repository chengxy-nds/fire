      ...
      <div class="m-login">
        ...
        <div class="m-login-warp">
          <form class="layui-form">
            ...
            <div class="layui-form-item">
              <div class="layui-inline">
                <img class="login-img-third" v-on:click="loginByGithub()" title="Github" src="@/assets/images/login/github.jpg"/>
              </div>
              <div class="layui-inline" style="">
                <img class="login-img-third" v-on:click="facelogin()"  title="人脸识别"  src="@/assets/images/login/renlian.jpg"/>
              </div>
            </div>
            <div class="layui-form-item">
